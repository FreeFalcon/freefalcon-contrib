...
// Base for all materials
#define	MATERIAL_SPECULARITY			DEFAULT_MAT_SPECULAR
#define	MATERIAL_INDEX					DEFAULT_MAT_DVPOWER
...
#define	PIT_FLOOD_LIGHT_SWITCH			128
#define	INSTR_FLOOD_LIGHT_SWITCH		127


DWORD	AssignSurfaceFeatures(BYTE*Model, DWORD CTNumber, DWORD MType=0);

#define	ASSIGN_SURFACE_FEATURE(Condition, Name)	if((Condition)){\
														NODE.SURFACE->SpecularIndex=Name##_INDEX;\
														NODE.SURFACE->DefaultSpecularity=Name##_SPECULARITY;\
														}
