...
public:
	...
	void UpdateLighting();
	void Draw();
	void DrawCumulus(Tpoint *position,int txtIndex);
...
public:
	...
	Texture cirrusTextures[NUM_STRATUS_TEXTURES];
	Texture cirrcumTextures[NUM_STRATUS_TEXTURES];
	Texture cumulusTextures[NUM_CUMULUS_TEXTURES];
	...
	float viewerX,viewerY,viewerZ,cumulusZ,stratusZ,stratus2Z,windSpeed,windHeading,puffRadius,cloudRadius,stratusRadius,stratusDepth;
