...
class BXDofNode: public BSubTree {
  public:
	...
	BXDofNode() : BSubTree()		{ dofNumber = -1; };
	virtual ~BXDofNode()		{};
...
class BTransNode: public BSubTree {
  public:
	...
	BTransNode() : BSubTree()		{ dofNumber = -1; };
	virtual ~BTransNode()		{};
	...
	virtual void		Draw(void);
	virtual BNodeType	Type(void)	{ return tagBTransNode; };
};
...
class BScaleNode: public BSubTree {
  public:
	...
	BScaleNode() : BSubTree()		{ dofNumber = -1; };
	virtual ~BScaleNode()		{};
...
class BXSwitchNode: public BNode {
  public:
	...
	BXSwitchNode()			{ subTrees = NULL; numChildren = 0; switchNumber = -1; };
...
class BRenderControlNode: public BNode {
  public:
	...
	BRenderControlNode()			{ Control = rcNoOp; };
	...
	virtual void		Draw(void);
	virtual BNodeType	Type(void)	{ return tagBRenderControlNode; };
};
