...
static const int MAX_STATE_STACK_DEPTH				= 1024;	// Arbitrary MLR 2003-10-11 Upped depth
...
static const int MAX_VERTS_PER_POLYGON				= 32000;	// Arbitrary
static const int MAX_VERT_POOL_SIZE					= 128000;	// Arbitrary
...
class StateStackClass
{
  ...
  public:
	...
	static void SetLODBias(float bias) { LODBiasInv = 1.f/bias; };
	...
	void pvtDrawObject(BRoot *CurrentLOD);
  ...
  public:
	...
	static	Pnormal		*pNormals;
	static	Ppoint		*pCoords;
