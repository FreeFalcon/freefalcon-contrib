...
class RenderGMComposite : public Render2D {
  public:
	...
	void	SetBeam( Tpoint *from, Tpoint *at, Tpoint *center, float platformHdg, float beamAngle, int beamPercent, float cursorAngle, BOOL movingRight );
  ...
  protected:
	bool	BackgroundGeneration( Tpoint *from, Tpoint *at, float platformHdg, int beamPercent, BOOL movingRight );
