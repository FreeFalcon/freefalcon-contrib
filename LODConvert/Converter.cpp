...
TriangleLoop:
		while(a<3){
			...
			if(Flags.b.VColor) {
				...
				// DX 2 - Not alpha surfaces must have a 0xff vertex Alpha
				if(!Flags.b.Alpha) VColor[a]|=0xff000000;
			}
...
void	SwapNodes(DXNode* &Root, DXNode *Node1, DXNode *Node2)
{
	//if 1st of list
	if(!Node1->Prev) Root=Node2;
