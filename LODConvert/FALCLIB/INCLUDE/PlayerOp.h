...
public:	// Retro
	...
	//JAM 08Dec03
	int ShadowsOn(void)										{ return (DispFlags & DISP_SHADOWS) && TRUE; }
...
//	int ObjectShadingOn (void)								{ return (ObjFlags & DISP_OBJ_SHADING) && TRUE; }
	...
	bool getInfoBar(void)									{ return infoBar; }				// Retro 25Dec2003
	bool getSubtitles(void)									{ return subTitles; }			// Retro 25Dec2003
	bool Get2dTrackIR(void)									{ return TrackIR_2d; }			// Retro 27Dec2003
	bool Get3dTrackIR(void)									{ return TrackIR_3d; }			// Retro 27Dec2003
	bool GetFFB(void)										{ return enableFFB; }			// Retro 27Dec2003
	bool GetMouseLook(void)									{ return enableMouseLook; }		// Retro 28Dec2003
...
// Retro_dead 15Jan2004	GUID GetJoystick (void)									{ return joystick; }
	...
	void SetInfoBar(bool onOff)								{ infoBar = onOff; }		// Retro 25Dec2003
	void SetSubtitles(bool onOff)							{ subTitles = onOff; }		// Retro 25Dec2003
	void SetTrackIR2d(bool onOff)							{ TrackIR_2d = onOff; }		// Retro 27Dec2003
	void SetTrackIR3d(bool onOff)							{ TrackIR_3d = onOff; }		// Retro 27Dec2003
	void SetFFB(bool onOff)									{ enableFFB = onOff; }		// Retro 27Dec2003
	void SetMouseLook(bool onOff)							{ enableMouseLook = onOff; }// Retro 28Dec2003

	void SetMouseLookSensitivity(float theVal)				{ MouseLookSensitivity = theVal; }	// Retro 15Jan2004 - x/y axis
	float GetMouseLookSensitivity(void)						{ return MouseLookSensitivity; }	// Retro 15Jan2004

	void SetMouseWheelSensitivity(int theVal)				{ MouseWheelSensitivity = theVal; }	// Retro 17Jan2004 - z axis
	int GetMouseWheelSensitivity(void)						{ return MouseWheelSensitivity; }	// Retro 17Jan2004

	void SetKeyboardPOVPanningSensitivity(int theVal)		{ KeyboardPOVPanningSensitivity = theVal; }	// Retro 18Jan2004
	int GetKeyboardPOVPanningSensitivity(void)				{ return KeyboardPOVPanningSensitivity; }	// Retro 18Jan2004

	bool GetClickablePitMode(void)							{ return clickablePitMode; }
	void SetClickablePitMode(bool onOff)					{ clickablePitMode = onOff; }

	bool GetAxisShaping(void)								{ return enableAxisShaping; }		// Retro 27Jan2004
	void SetAxisShaping(bool onOff)							{ enableAxisShaping = onOff; }		// Retro 27Jan2004
};	
