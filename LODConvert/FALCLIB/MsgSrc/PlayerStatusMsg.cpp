/*
 * Machine Generated source file for message "Player Enter/Exit Sim".
...
FalconPlayerStatusMessage::FalconPlayerStatusMessage(VU_MSG_TYPE type, VU_ID senderid, VU_ID target) : FalconEvent (PlayerStatusMsg, FalconEvent::SimThread, senderid, target)
{
	RequestOutOfBandTransmit();
	RequestReliableTransmit();//me123
   // Your Code Goes Here
...
FalconPlayerStatusMessage::~FalconPlayerStatusMessage(void)
{
   // Your Code Goes Here
}
