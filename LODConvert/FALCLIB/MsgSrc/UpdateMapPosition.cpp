...
/*
UI_UpdateMapPosition::UI_UpdateMapPosition(VU_ID entityId, VuTargetEntity *target, VU_BOOL loopback) : FalconEvent (UpdateMapPosition, FalconEvent::UIThread, entityId, target, loopback)
{
   // Your Code Goes Here
}
