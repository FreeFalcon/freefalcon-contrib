...
FalconRequestCampaign::FalconRequestCampaign(VU_ID entityId, VuTargetEntity *target, VU_BOOL loopback) : FalconEvent (RequestCampaignMsg, FalconEvent::CampaignThread, entityId, target, loopback)
{
   // Your Code Goes Here
}
...
int FalconRequestCampaign::Process(void)
	...
	FalconSendCampaign*	msg = new FalconSendCampaign(dataBlock.requester_session,dataBlock.requester_session,VU_SPECIFIED_TARGET);
