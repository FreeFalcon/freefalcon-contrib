...
{
	float delta = 0;//TheTimeManager.GetDeltaTime() * 540.0f * DegreesPerSecond;
...
{
	float delta = 0;//TheTimeManager.GetDeltaTime() * 200.0f * DegreesPerSecond;
...
static void Beacon(void)
{
	...
	float delta = 0;//TheTimeManager.GetDeltaTime() * 36.0f * DegreesPerSecond;
...
static void E3(void)
{
	float delta = 0;//TheTimeManager.GetDeltaTime() * 135.0f * DegreesPerSecond;
...
{
	float delta = 0;//TheTimeManager.GetDeltaTime() * 500.0f * DegreesPerSecond;
...
{
	float delta = 0;//TheTimeManager.GetDeltaTime() * 360.0f * DegreesPerSecond;
...
{
	float delta = 0;//TheTimeManager.GetDeltaTime() * 600.0f * DegreesPerSecond;
