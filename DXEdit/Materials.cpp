...
////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// LIGHTS
	if(gClass==7 && (PresentSwitch==LANDING_LIGHT_SWITCH || PresentSwitch==NAV_LIGHT_SWITCH) && AssignedLights<128 && NODE.SURFACE->dwFlags.b.Point){
		...
		if(PresentSwitch==NAV_LIGHT_SWITCH){
			...
			ModelLights[AssignedLights].OwnLight=true;
		...
		if(PresentSwitch==LANDING_LIGHT_SWITCH){
			...
			ModelLights[AssignedLights].OwnLight=false;
...
Done:
	...
	// PITs
	if(PNumber==1 || PNumber==1196 || PNumber==3759){
		...
		if(PresentSwitch==3){
			...
			// unlited surfaces
			if(NODE.SURFACE->dwFlags.b.Lite==0) {
...
DWORD	AssignSurfaceFeatures(BYTE*Model, DWORD CTN)
{
	DWORD	DofLevel=0;
