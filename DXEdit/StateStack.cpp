...
Pnormal		*StateStackClass::pNormals;
Ppoint		*StateStackClass::pCoords;
...
void StateStackClass::pvtDrawObject(BRoot *CurrentLOD)
{
//	UInt32 clipFlag;
//	float MaxLODRange;
	static int in = 0;
...
//	ShiAssert(objInst);
	...
	PushAll();
	Rotation.M11=1.0f; Rotation.M12=0.0f; Rotation.M13=0.0f;
	Rotation.M21=0.0f; Rotation.M22=1.0f; Rotation.M23=0.0f;
	Rotation.M31=0.0f; Rotation.M32=0.0f; Rotation.M33=1.0f;
...
void StateStackClass::PushAll(void)
{
	...
	stack[stackDepth].pNormals		= pNormals;
	stack[stackDepth].pCoords		= pCoords;
	...
	stack[stackDepth].BillBoard=CV->BillBoard;
...
void StateStackClass::PopAll(void)
{
	...
	pNormals=			stack[stackDepth].pNormals;
	pCoords=			stack[stackDepth].pCoords;
	CV->BillBoard=stack[stackDepth].BillBoard;
...
/*//	float scratch_x,scratch_y,scratch_z;
	...
	while(n--)
	{
		XformedPosPoolNext->z = p->z;
		XformedPosPoolNext->x = p->x;
		XformedPosPoolNext->y = p->y;
		XformedPosPoolNext++;
		p++;
	}*/
}
